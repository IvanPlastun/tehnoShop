...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Апр 12 2019 г., 22:01
...
(5, 'Apple MacBook Air 13\" Dual-Core i5 1,6 ГГц, 8 ГБ, 256 ГБ SSD, «серый космос»', 120990, 'Новый MacBook Air — ещё более тонкий и лёгкий, оснащён дисплеем Retina, клавиатурой нового поколения, трекпадом Force Touch и технологией Touch ID, которая защищает ваши данные и открывает доступ к ним только вам. Это самый экологичный Mac. Для его корпуса используется только переработанный алюминий.1 И это невероятно удобный MacBook Air, который справится с любыми задачами. \r\n', 'macbook.jpg', 'Ноутбуки', NULL, 1),
(6, 'Apple Mac mini Core i5 3,0 ГГц, 8 ГБ, SSD 256 ГБ, Intel UHD Graphics 630', 91990, 'Mac mini — мощный настольный компьютер, контроллер для домашней автоматики, основа масштабных рендер?ферм. И многое, очень многое другое. Теперь Mac mini оснащён 4?ядерным или 6?ядерным процессором Intel восьмого поколения и графикой Intel UHD Graphics 630. А значит, у него ещё больше вычислительной мощности для выполнения ресурсоёмких задач. Что бы вы ни делали — от обработки звука с концерта до тестирования своего приложения для iOS, — Mac mini ускорит воплощение любой идеи.\r\n', 'mac-mini.jpg', 'Компьютеры', NULL, 1),
(7, 'Apple Mac Pro Intel Xeon E5 3,5 ГГц (6 ядер), 16 ГБ, 2x AMD FirePro D500, 256 ГБ Flash', 249990, 'Профессиональная рабочая станция. Может использоваться для решения самых сложных творческих задач, а также для математических или научных расчетов. Оснащена серверным процессором Intel Xeon нового поколения, производительной серверной архитектурой, двумя мощнейшими графическими адаптерами и сверхскоростным Flash-накопителем. Заключена в безупречный корпус из полированного алюминия с передовой системой охлаждения, которая обеспечивает тихую работу даже при интенсивных нагрузках.', 'mac-pro.jpg', 'Компьютеры', NULL, 1);
